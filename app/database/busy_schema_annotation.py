...
Scope (v1): Sales Analysis, Purchase Analysis, Stock/Inventory,
...
TABLE: Tran2  (universal transaction/ledger line table, ~105 columns)
  ...
  - Balance1/2/3 (float)  : running balance -- ONLY populated for some
                            ...
                            these for Outstanding Balance; use the net
                            movement formula instead (see below).

  SIGN CONVENTION (confirmed on party/account rows, MasterCode1 -> MasterType=2):
